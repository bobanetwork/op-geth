...
type Engine interface {
	...
	FinalizeAndAssemble(chain ChainHeaderReader, header *types.Header, state *state.StateDB, body *types.Body, receipts []*types.Receipt, rejected []types.RejectedTransaction) (*types.Block, error)
